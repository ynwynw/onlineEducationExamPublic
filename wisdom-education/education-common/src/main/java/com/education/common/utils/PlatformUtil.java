...
public class PlatformUtil {
    ...
    private static final boolean WINDOWS_32_BIT = os.startsWith("Windows") && !System.getProperty("os.arch").contains("64");
    ...
    /**
     * Returns true if the operating system is a form of Windows 32-bit.
     */
